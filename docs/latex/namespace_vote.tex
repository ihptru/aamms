...
\item[{\em target\_\-human}]The human readable target of the vote (What is the vote about? ). Used for displaying. \item[{\em action}]Function that is executed when the vote successed. \item[{\em force}]Cancel current vote if a vote is already active? \end{DoxyParams}


Definition at line 51 of file Vote.py.
...
Definition at line 63 of file Vote.py.
...
Definition at line 185 of file Vote.py.
